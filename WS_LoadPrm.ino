...
void set_default_prm()
      {
        ...
        // Default parameter               
        Prm = (struct_param){
          212,          //Parameter State  212 if ok 
          -7.2438770,   //NLA -- Latitude
          107.2454630,  //NLO -- Longitude
          86,           //NAL -- Altitude
          7,            //NTZ -- Time zone
          1,            //NMT -- Masjid tipe
          20,           //NBL -- Brightness light
          2,            //NIH -- waktu ihtiyati sholat 
          10,           //NSO -- waktu tunggu sholat, 10
          30,           //NJM -- waktu tunggu khutbah jumat, 30
          10,           //NI1 -- waktu iqomah subuh, 15
          5,            //NI4 -- waktu iqomah Dhuhur, 10
          5,            //NI5 -- waktu iqomah Ashar, 10
          3,            //NI6 -- waktu iqomah Magrib, 7
          5,            //NI7 -- waktu iqomah Isya, 10
          1,            //NBZ -- Buzzer on/off
          1,            //NSI -- Imsak on/off
          0,            //NST -- Terbit on/off
          0             //NSU -- Dhuha on/off
        ...
        EEPROM.put(0,Prm);
        EEPROM.put(55, "AL ISLAM PASANGGRAHAN\0");
        EEPROM.put(130, "Harap Tenang dan Non-aktifkan HP Anda!\0");
        EEPROM.put(280,"Info 2\0");
        EEPROM.put(430,"Info 3\0");
        EEPROM.put(580,"Luruskan dan rapatkan Shaf sebelum Sholat ...\0");
        EEPROM.put(730,"Harap Tenang dan Non-aktifkan HP Anda!\0");
      }
